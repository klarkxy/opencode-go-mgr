...
pub use crate::kernel::ids::{
    ...
    OLLAMA_CLOUD_CHAT_COMPLETIONS_PATH, OLLAMA_CLOUD_MODELS_PATH, OLLAMA_CLOUD_SETTINGS_URL,
...
pub use ocg_domain::provider::{
    ...
    OLLAMA_CLOUD_MODEL_SOURCE, OPENCODE_CONSTRUCTABLE_PROTOCOLS, PROTOCOL_FALLBACK_CHAT_MESSAGES,
